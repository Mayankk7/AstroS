...
const Space = () => {
  return (
    <div className='h-[100vh] w-[100vw] bg-location bg-center bg-no-repeat bg-cover'>
      ...
      <div className='border-[1px] border-white w-[50vw] ml-[9.5vw] mt-8 rounded-[30px] bg-spacecard bg-center bg-cover bg-no-repeat h-[60vh]'>
        ...
        <button className='text-white px-4 w-[15vw] rounded-lg mt-10 font-inter hover:border-2 hover:bg-white hover:text-black ml-[17vw] py-2 border-[1px] border-white'>
            View More
        </button>
      </div>
    </div>
